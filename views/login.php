...
<div class="loginBox"> <img class="user" src="../imgs/cog.png" height="100px" width="100px">
        ...
        <form action="" method="post">
            <div class="inputBox"> <input id="uname" type="text" name="email" placeholder="Correo" required> 
            <input id="pass" type="password" name="password" placeholder="Contraseña" required> </div> 
            <input type="submit" value="Iniciar">
        </form> 
        <a href="#">Olvide mi contraseña<br> </a>
        <div class="text-center">
            <a href="register.php"><p style="color: #59238F;">Aun no tiene una cuenta? Registrase</p></a>
        </div>
